...
// line start: 569
// line end:   995
void Back__6Dialogiiii_addr_8008BC34(struct Dialog *this, int DX, int DY, int DW, int DH) {
	// register: 30
	register int X;
	// register: 23
	register int Y;
...
// line start: 406
// line end:   459
void DropShadows__Fiiii_addr_80083754(int x, int y, int w, int h) {
	// register: 2
	// size: 0x24
	register struct POLY_G4 *G4;
	// register: 19
...
// line start: 496
// line end:   552
void GetSizes__6Dialog_addr_8008630C(struct Dialog *this) {
	// register: 3
	// size: 0xC
