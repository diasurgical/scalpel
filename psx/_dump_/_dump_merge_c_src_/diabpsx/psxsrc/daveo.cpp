...
// line start: 491
// line end:   557
long DetectDup__FP10ItemStructi_addr_80084C8C(struct ItemStruct_dup_17 *Item, int PlayerNo) {
	// register: 6
	register long Value;
	// register: 3
	// size: 0x6C
...
// line start: 642
// line end:   715
void KeefDaFeef__Fi_addr_80085074(int PlayerNo) {
	// register: 17
	register int i;
	// register: 19
	register int InvItem;
...
// line start: 65
// line end:   112
void ReadPad__Fi_addr_8007CB84(int NoDeb) {
	// register: 16
	// size: 0x6C
...
// line start: 71
// line end:   137
void ReadPad__Fi_addr_80084384(int NoDeb) {
	// register: 16
	// size: 0xEC
	register struct CPad_dup_17 *DPad;
	// register: 2
	register int New;
	// register: 4
	register int cmem;
...
// line start: 64
// line end:   92
void ReadPad__Fi_addr_8007B10C(int NoDeb) {
	// register: 2
	// size: 0x6C
	register struct CPad *Pad;
	// register: 2
...
// line start: 562
// line end:   633
void WinterSales__Fi_addr_80084E38(int PlayerNo) {
	// register: 16
	register int Value;
	// register: 17
	register int i;
