...
// line start: 1688
// line end:   1868
short PlayFMVOverLay_addr_80139868(char *filename, int w, int h) {
	// register: 20
	register int start_time;
	// register: 22
	register int start_frame;
...
// line start: 238
// line end:   384
short PlayFMVOverLay_addr_80135E98(struct StrInfo *str) {
	// address: 0xFFFFFFC0
	// size: 0x18
	auto struct CdlFILE fp;
	// register: 16
...
// line start: 1696
// line end:   1886
short PlayFMVOverLay_addr_8013A0AC(char *filename, int w, int h) {
	// register: 20
	register int start_time;
	// register: 23
	register int start_frame;
...
// line start: 1673
// line end:   1686
void StrClearVRAM_addr_80139FEC() {
	// address: 0xFFFFFFE8
	// size: 0x8
	auto struct RECT clrRect;
}
