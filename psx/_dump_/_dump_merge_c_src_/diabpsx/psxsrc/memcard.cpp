...
// line start: 892
// line end:   974
void service_card__Fi_addr_801435F4(int card_number) {
	// register: 18
	register int old_status;
}
...
// line start: 280
// line end:   399
void read_card_directory__Fi_addr_8013E490(int card_number) {
	// address: 0xFFFFFF78
	// size: 0x50
	auto char path[80];
	// register: 17
...
// line start: 572
// line end:   690
int read_card_file__FiiiPc_addr_80143010(int card_number, int file, int id, char *buf) {
	// register: 19
	register int okay;
	// register: 20
	register int tries;
...
// line start: 939
// line end:   1028
void service_card__Fi_addr_80143678(int card_number) {
	// register: 4
...
// line start: 251
// line end:   270
int sjis_to_ascii__FPUsPc_addr_80142B00(unsigned short *sjis, char *asc) {
}
...
// line start: 757
// line end:   884
int write_card_file__FiiPcT2PUcPUsiT4_addr_801432B0(int card_number, int id, char *name, char *title, unsigned char *icon, unsigned short *clut, int size, unsigned char *buf) {
	// address: 0xFFFFFD90
	// size: 0x200
	auto struct file_header h;
	// register: 16
