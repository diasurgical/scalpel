...
// line start: 1593
// line end:   1608
unsigned char AreBlocksColliding_addr_80022610(struct MEM_HDR_dup_17 *Hdr1, struct MEM_HDR_dup_17 *Hdr2) {
	// register: 5
	register unsigned long Addr1;
	// register: 6
	register unsigned long Addr2;
...
// line start: 1212
// line end:   1239
struct MEM_HDR_dup_17 *FindBlockInTheseBounds_addr_8002201C(struct MEM_HDR_dup_17 *Head, void *Addr, unsigned long Size) {
	// register: 4
	// size: 0x1C
...
// line start: 855
// line end:   888
struct MEM_HDR_dup_17 *FindHighestMemBlock_addr_80021BC8(struct MEM_HDR_dup_17 *Head, unsigned long Size) {
	// register: 6
	// size: 0x1C
	register struct MEM_HDR_dup_17 *Closest;
	// register: 4
...
// line start: 190
// line end:   241
long GAL_SplitBlock_addr_8001FB3C(long CurBlock, unsigned long Size) {
	// register: 19
	// size: 0x28
	register struct MEM_INIT_INFO *M;
	// register: 16
...
// line start: 1245
// line end:   1262
struct MEM_HDR *GetFreeMemHdrBlock_addr_800208D4() {
	// register: 16
	// size: 0x20
	register struct MEM_HDR *RetBlock;
}
...
// line start: 2062
// line end:   2097
unsigned char GetRegion_addr_80022C34(struct MEM_REG *Reg, struct MEM_HDR *LockedBlocks, struct MEM_INIT_INFO *M) {
	// register: 3
	// size: 0x1C
...
// line start: 2303
// line end:   2326
void GraftMemHdrList_addr_80022F28(struct MEM_HDR_dup_17 **ToList, struct MEM_HDR_dup_17 **FromList) {
	// register: 6
	// size: 0x1C
...
// line start: 1972
// line end:   1996
void PutBlocksInRegionIntoList_addr_8002132C(struct MEM_REG *Reg, struct MEM_HDR **ToList, struct MEM_HDR **FromList) {
	// register: 16
	// size: 0x20
	register struct MEM_HDR *ThisBlock;
	{
...
// line start: 2472
// line end:   2521
void SortMemHdrList_addr_80021954(struct MEM_HDR **Head, unsigned char (*CompFunc)()) {
	// register: 18
	register unsigned char DidASwap;
	// register: 16
	// size: 0x20
...
// line start: 2464
// line end:   2465
unsigned char SortSize_addr_80023108(struct MEM_HDR_dup_17 *B1, struct MEM_HDR_dup_17 *B2);
