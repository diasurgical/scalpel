...
// line start: 3236
// line end:   3297
void BreakBarrel__FiiiUcUc_addr_8005763C(int pnum, int i, int dam, unsigned char forcebreak, int sendmsg) {
	// register: 17
	register int x;
	// register: 18
	register int y;
...
// line start: 3303
// line end:   3324
void BreakObject__Fii_addr_8005A690(int pnum, int oi) {
	// register: 17
	register int objdam;
	// register: 17
	register int mind;
...
// line start: 891
// line end:   955
void DrawExpl__Fiiiiiccc_addr_8005440C(int sx, int sy, int f, int ot, int scale, int rtint, int gtint, int btint) {
	// register: 4
	// size: 0x28
	register struct POLY_FT4 *Ft4;
	// register: 30
...
// line start: 1417
// line end:   1461
void MonstCheckDoors__Fi_addr_80050888(int m) {
	// register: 20
	register int i;
	// register: 16
	register int oi;
...
// line start: 977
// line end:   1002
void Obj_Door__Fi_addr_80054774(int i) {
	// register: 18
	register int dx;
	// register: 19
	register int dy;
...
// line start: 758
// line end:   809
void Obj_Trap__Fi_addr_8004E70C(int i) {
	// register: 16
	register int oti;
	// register: 5
	register unsigned char otrig;
...
// line start: 1990
// line end:   2071
void OperateBookLever__Fii_addr_8005126C(int pnum, int i) {
	// register: 20
	register int x;
	// register: 19
	register int y;
...
// line start: 1920
// line end:   1978
void OperateBook__Fii_addr_80050BA8(int pnum, int i) {
	// register: 20
	register int v1;
	// register: 18
	register int v2;
...
// line start: 1527
// line end:   1576
void OperateL1LDoor__FiiUc_addr_80055DF8(int pnum, int oi, unsigned char sendflag) {
	// register: 20
	register int dx;
	// register: 19
	register int dy;
...
// line start: 1676
// line end:   1715
void OperateL3RDoor__FiiUc_addr_80056868(int pnum, int oi, unsigned char sendflag) {
	// register: 18
	register int dx;
	// register: 19
	register int dy;
...
// line start: 2919
// line end:   2932
void OperateLazStand__Fii_addr_80056A18(int pnum, int i) {
	// address: 0xFFFFFFF0
	auto int x;
	// address: 0xFFFFFFF4
	auto int y;
...
// line start: 2234
// line end:   2273
void OperateMushPatch__Fii_addr_80058D28(int pnum, int i) {
	// address: 0xFFFFFFE8
	auto int x;
	// address: 0xFFFFFFEC
	auto int y;
...
// line start: 2471
// line end:   2561
void OperatePedistal__Fii_addr_80059A68(int pnum, int i) {
	// address: 0xFFFFFFE0
	auto int jstn;
	// register: 19
	register bool JustOperated;
...
// line start: 2045
// line end:   2598
void OperateShrine__Fiii_addr_8005341C(int pnum, int i, int sType) {
	// register: 18
	register int r;
	// register: 4
	register int xx;
...
// line start: 4449
// line end:   4617
void RestoreObjectLight__Fv_addr_8005F6D8() {
	// register: 17
	register int i;
	// register: 2
	register int oi;
...
// line start: 3484
// line end:   3507
void SyncL3Doors__Fi_addr_800583D4(int i) {
	// register: 7
	register int dx;
	// register: 5
	register int dy;
...
// line start: 3515
// line end:   3554
void SyncObjectAnim__Fi_addr_8005B150(int o) {
	// register: 4
	register int ai;
	// register: 3
	register int ot;
...
// line start: 3429
// line end:   3444
void SyncPedistal__Fi_addr_80058110(int i) {
	// register: 16
	register unsigned char *setp;
	{
		{
