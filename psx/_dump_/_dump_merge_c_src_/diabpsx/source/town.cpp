...
// line start: 216
// line end:   275
void T_FillSector__FPUcT0iiiib_addr_80074308(unsigned char *P3Tiles, unsigned char *pSector, int xi, int yi, int w, int h, bool AddSec) {
	// register: 17
	register int i;
	// register: 22
	register int j;
...
// line start: 330
// line end:   406
void T_Pass3__Fv_addr_8006F708() {
	// register: 19
	register unsigned char *pSector;
	// register: 16
	register int xx;
