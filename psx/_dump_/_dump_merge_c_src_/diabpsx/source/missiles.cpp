...
// line start: 1601
// line end:   1643
void AddFirebolt__Fiiiiiicii_addr_80132CDC(int mi, int sx, int sy, int dx, int dy, int midir, int micaster, int id, int dam) {
	// register: 3
	register int sp;
	// register: 17
	register int i;
...
// line start: 2855
// line end:   2902
void AddFirewallC__Fiiiiiicii_addr_80136424(int mi, int sx, int sy, int dx, int dy, int midir, int mienemy, int id, int dam) {
	// register: 22
	register int i;
	// register: 19
	register int pn;
...
// line start: 3052
// line end:   3081
void AddFlame__Fiiiiiicii_addr_80136F7C(int mi, int sx, int sy, int dx, int dy, int midir, int mienemy, int id, int seqno) {
	// register: 3
	register int i;
}
...
// line start: 2618
// line end:   2663
void AddGolem__Fiiiiiicii_addr_80135B48(int mi, int sx, int sy, int dx, int dy, int midir, int mienemy, int id, int dam) {
	// register: 5
	register int i;
	// register: 3
	register int mx;
...
// line start: 2101
// line end:   2159
void AddGuardian__Fiiiiiicii_addr_80134AE8(int mi, int sx, int sy, int dx, int dy, int midir, int mienemy, int id, int dam) {
	// register: 20
	register int i;
	// register: 19
	register int pn;
...
// line start: 1575
// line end:   1626
void AddRndTeleport__Fiiiiiicii_addr_80123D24(int mi, int sx, int sy, int dx, int dy, int midir, int mienemy, int id, int dam) {
	// register: 2
	register int pn;
	// register: 17
	register int r1;
...
// line start: 2576
// line end:   2637
void AddStone__Fiiiiiicii_addr_801290E8(int mi, int sx, int sy, int dx, int dy, int midir, int mienemy, int id, int dam) {
	// register: 6
	register int i;
	// register: 9
	register int j;
...
// line start: 1718
// line end:   1754
void AddTeleport__Fiiiiiicii_addr_80126E14(int mi, int sx, int sy, int dx, int dy, int midir, int mienemy, int id, int dam) {
	// register: 10
	register int i;
	// register: 2
	register int pn;
...
// line start: 1966
// line end:   2031
void AddTown__Fiiiiiicii_addr_80127B44(int mi, int sx, int sy, int dx, int dy, int midir, int mienemy, int id, int dam) {
	// register: 17
	register int i;
	// register: 4
	register int pn;
...
// line start: 434
// line end:   450
int CheckBlock__Fiiii_addr_80123204(int fx, int fy, int tx, int ty) {
	// register: 2
	register int pn;
	// register: 20
	register int coll;
...
// line start: 1202
// line end:   1293
void CheckMissileCol__FiiiUciiUc_addr_80128514(int i, int mindam, int maxdam, unsigned char shift, int mx, int my, int nodel) {
	// register: 2
	register int pn;
	// register: 5
	register int oi;
...
// line start: 1191
// line end:   1280
void CheckMissileCol__FiiiUciiUc_addr_80131B3C(int i, int mindam, int maxdam, unsigned char shift, int mx, int my, int nodel) {
	// register: 16
	register int pn;
	// register: 5
	register int oi;
...
// line start: 265
// line end:   416
void GetDamageAmt__FiPiT1_addr_8012574C(int i, int *mind, int *maxd) {
	// register: 4
	register int k;
	// register: 5
	register int sl;
...
// line start: 265
// line end:   416
void GetDamageAmt__FiPiT1_addr_80139294(int i, int *mind, int *maxd) {
	// register: 4
	register int k;
	// register: 5
	register int sl;
...
// line start: 257
// line end:   408
void GetDamageAmt__FiPiT1_addr_8012EA6C(int i, int *mind, int *maxd) {
	// register: 5
	register int k;
	// register: 4
	register int sl;
...
// line start: 265
// line end:   416
void GetDamageAmt__FiPiT1_addr_801202F4(int i, int *mind, int *maxd) {
	// register: 4
	register int k;
	// register: 5
	register int sl;
...
// line start: 265
// line end:   416
void GetDamageAmt__FiPiT1_addr_80124F64(int i, int *mind, int *maxd) {
	// register: 4
	register int k;
	// register: 5
	register int sl;
...
// line start: 265
// line end:   416
void GetDamageAmt__FiPiT1_addr_80137D2C(int i, int *mind, int *maxd) {
	// register: 4
	register int k;
	// register: 5
	register int sl;
	// register: 5
	// size: 0x23A8
	register struct PlayerStruct_dup_11 *plr;
	// register: 9
	register int _pMagic;
	// register: 8
	register char _pLevel;
...
// line start: 265
// line end:   416
void GetDamageAmt__FiPiT1_addr_80121A8C(int i, int *mind, int *maxd) {
	// register: 4
	register int k;
	// register: 5
	register int sl;
...
// line start: 265
// line end:   416
void GetDamageAmt__FiPiT1_addr_801301B4(int i, int *mind, int *maxd) {
	// register: 4
	register int k;
	// register: 5
	register int sl;
	// register: 5
	// size: 0x23A8
	register struct PlayerStruct_dup_6 *plr;
	// register: 9
	register int _pMagic;
	// register: 8
	register char _pLevel;
...
// line start: 660
// line end:   691
void GetMissilePos__Fi_addr_8012FA38(int i) {
	// register: 7
	register long mx;
	// register: 10
	register long my;
...
// line start: 623
// line end:   631
void GetMissileVel__Fiiiiii_addr_80123770(int i, int sx, int sy, int dx, int dy, int v) {
	// register: 16
	register long dxp;
	// register: 18
	register long dyp;
...
// line start: 5001
// line end:   5025
void MI_Apoca__Fi_addr_80130E60(int i) {
	// register: 19
	register int j;
	// register: 17
	register int k;
...
// line start: 4380
// line end:   4416
void MI_Chain__Fi_addr_80131760(int i) {
	// register: 20
	// size: 0x50
	register struct MissileStruct *miss;
	// register: 23
...
// line start: 5350
// line end:   5430
void MI_Element__Fi_addr_80132340(int i) {
	// register: 2
	register int mid;
	// register: 16
	register int sd;
...
// line start: 4247
// line end:   4289
void MI_Firemove__Fi_addr_8012F088(int i) {
	// register: 18
	register int j;
	// address: 0xFFFFFFA8
	// size: 0x38
...
// line start: 4951
// line end:   4984
void MI_FirewallC__Fi_addr_8012DEF8(int i) {
	// register: 20
	register int tx;
	// register: 19
	register int ty;
...
// line start: 4965
// line end:   4999
void MI_FirewallC__Fi_addr_80132880(int i) {
	// register: 16
	// size: 0x50
	register struct MissileStruct *miss;
	// register: 19
...
// line start: 4948
// line end:   4981
void MI_FirewallC__Fi_addr_80130A40(int i) {
	// register: 20
	register int tx;
	// register: 19
	register int ty;
...
// line start: 5230
// line end:   5256
void MI_Flamec__Fi_addr_80131AA8(int i) {
	// register: 18
	register int id;
	// register: 2
	register int pn;
...
// line start: 4112
// line end:   4137
void MI_Flash2__Fi_addr_80130D38(int i) {
	// register: 17
	// size: 0x50
	register struct MissileStruct *miss;
}
...
// line start: 4074
// line end:   4107
void MI_Flash__Fi_addr_801309E4(int i) {
	// register: 17
	// size: 0x50
	register struct MissileStruct *miss;
}
...
// line start: 4308
// line end:   4375
void MI_Guardian__Fi_addr_801314B0(int i) {
	// register: 18
	register int j;
	// register: 22
	register int k;
...
// line start: 3523
// line end:   3609
void MI_LArrow__Fi_addr_80128EF8(int i) {
	// register: 18
	register int p;
	// register: 17
	register int mind;
...
// line start: 3938
// line end:   3996
void MI_Lightctrl__Fi_addr_8012DA74(int i) {
	// register: 3
	register int pn;
	// register: 20
	register int dam;
...
// line start: 3944
// line end:   4003
void MI_Lightctrl__Fi_addr_80130334(int i) {
	// register: 3
	register int pn;
	// register: 19
	register int dam;
...
// line start: 4006
// line end:   4024
void MI_Lightning__Fi_addr_801306B0(int i) {
	// register: 18
	register int j;
	// register: 16
	// size: 0x50
...
// line start: 4133
// line end:   4206
void MI_Manashield__Fi_addr_8012BF74(int i) {
	// register: 3
	register int j;
	// register: 17
	register int id;
...
// line start: 4130
// line end:   4203
void MI_Manashield__Fi_addr_8012EA80(int i) {
	// register: 4
	register int j;
	// register: 17
	register int id;
...
// line start: 4142
// line end:   4217
void MI_Manashield__Fi_addr_80130F00(int i) {
	// register: 3
	register int j;
	// register: 18
	register int id;
...
// line start: 4142
// line end:   4217
void MI_Manashield__Fi_addr_801436EC(int i) {
	// register: 3
	register int j;
	// register: 18
	register int id;
...
// line start: 5044
// line end:   5089
void MI_Nova__Fi_addr_8013E5C4(int i) {
	// address: 0xFFFFFFC8
	auto int k;
	// register: 21
	register int id;
...
// line start: 4588
// line end:   4637
void MI_Teleport__Fi_addr_8012D4E8(int i) {
	// register: 18
	register int id;
	// register: 19
	// size: 0xE0
...
// line start: 4537
// line end:   4586
void MI_Teleport__Fi_addr_8013CDE8(int i) {
	// register: 18
	register int id;
	// register: 19
	// size: 0xDC
...
// line start: 4602
// line end:   4651
void MI_Teleport__Fi_addr_80146C4C(int i) {
	// register: 18
	register int id;
	// register: 19
	// size: 0xE0
...
// line start: 4021
// line end:   4060
void MI_Town__Fi_addr_8012E15C(int i) {
	// register: 17
	register int p;
	// address: 0xFFFFFFA0
	// size: 0x44
...
// line start: 4029
// line end:   4069
void MI_Town__Fi_addr_801445E8(int i) {
	// register: 17
	register int p;
	// address: 0xFFFFFFA0
	// size: 0x44
...
// line start: 4029
// line end:   4069
void MI_Town__Fi_addr_8013079C(int i) {
	// register: 17
	register int p;
	// address: 0xFFFFFFA0
	// size: 0x44
...
// line start: 4029
// line end:   4069
void MI_Town__Fi_addr_80142F98(int i) {
	// register: 17
	register int p;
	// address: 0xFFFFFFA0
	// size: 0x44
...
// line start: 5030
// line end:   5085
void MI_Wave__Fi_addr_801310F4(int i) {
	// address: 0xFFFFFF80
	auto int dira;
	// address: 0xFFFFFF88
	auto int dirb;
...
// line start: 4982
// line end:   5037
void MI_Wave__Fi_addr_8013E01C(int i) {
	// address: 0xFFFFFF88
	auto int dira;
	// address: 0xFFFFFF90
	auto int dirb;
...
// line start: 637
// line end:   651
void PutMissile__Fi_addr_801238CC(int i) {
	// register: 6
	register int mx;
	// register: 5
	register int my;
...
// line start: 1311
// line end:   1330
void SetMissAnim__Fii_addr_80126150(int mi, int animtype) {
	// register: 18
	register int dir;
}
...
// line start: 2641
// line end:   2665
void AddAcidpud__Fiiiiiicii_addr_80140560(int mi, int sx, int sy, int dx, int dy, int midir, int mienemy, int id, int dam) {
	// register: 16
	register int monst;
}
...
// line start: 3435
// line end:   3446
void AddDiabApoca__Fiiiiiicii_addr_8014280C(int mi, int sx, int sy, int dx, int dy, int midir, int mienemy, int id, int dam) {
	// register: 19
	register int pnum;
}
...
// line start: 2982
// line end:   3030
void AddFirewallC__Fiiiiiicii_addr_8014125C(int mi, int sx, int sy, int dx, int dy, int midir, int mienemy, int id, int dam) {
	// register: 21
	register int i;
	// register: 22
	register int k;
...
// line start: 2745
// line end:   2790
void AddGolem__Fiiiiiicii_addr_8014094C(int mi, int sx, int sy, int dx, int dy, int midir, int mienemy, int id, int dam) {
	// register: 19
	register int i;
	// register: 3
	register int mx;
...
// line start: 2225
// line end:   2284
void AddGuardian__Fiiiiiicii_addr_8013FB38(int mi, int sx, int sy, int dx, int dy, int midir, int mienemy, int id, int dam) {
	// register: 19
	register int i;
	// register: 22
	register int k;
...
// line start: 3451
// line end:   3525
int AddMissile__Fiiiiiiciii_addr_80142948(int sx, int sy, int v1, int v2, int midir, int mitype, int micaster, int id, int v3, int spllvl) {
	// register: 16
	register int mi;
	// address: 0xFFFFFF98
	// size: 0x40
...
// line start: 1646
// line end:   1698
void AddRndTeleport__Fiiiiiicii_addr_8013DB50(int mi, int sx, int sy, int dx, int dy, int midir, int mienemy, int id, int dam) {
	// register: 19
	register int r1;
	// register: 18
	register int r2;
...
// line start: 3412
// line end:   3431
void AddRportal__Fiiiiiicii_addr_801426EC(int mi, int sx, int sy, int dx, int dy, int midir, int mienemy, int id, int dam) {
	// register: 4
	register int m2;
	{
		{
...
// line start: 3412
// line end:   3431
void AddRportal__Fiiiiiicii_addr_801425E4(int mi, int sx, int sy, int dx, int dy, int midir, int mienemy, int id, int dam) {
	// register: 4
	register int m2;
	{
		{
...
// line start: 2669
// line end:   2731
void AddStone__Fiiiiiicii_addr_80140640(int mi, int sx, int sy, int dx, int dy, int midir, int mienemy, int id, int dam) {
	// register: 6
	register int i;
	// register: 8
	register int j;
...
// line start: 1791
// line end:   1828
void AddTeleport__Fiiiiiicii_addr_8013E1B4(int mi, int sx, int sy, int dx, int dy, int midir, int mienemy, int id, int dam) {
	// register: 21
	register int i;
	// register: 22
	register int k;
...
// line start: 2050
// line end:   2123
void AddTown__Fiiiiiicii_addr_8013F0CC(int mi, int sx, int sy, int dx, int dy, int midir, int mienemy, int id, int dam) {
	// register: 21
	register int i;
	// register: 30
	register int k;
...
// line start: 443
// line end:   463
int CheckBlock__Fiiii_addr_8013A454(int fx, int fy, int tx, int ty) {
	// register: 20
	register int coll;
}
...
// line start: 2028
// line end:   2046
unsigned char CheckIfTrig__Fii_addr_8013EF24(int x, int y) {
	// register: 19
	register int i;
}
...
// line start: 1261
// line end:   1355
void CheckMissileCol__FiiiUciiUcb_addr_8013CEB8(int i, int mindam, int maxdam, unsigned char shift, int mx, int my, int nodel, bool HurtPlr) {
	// register: 5
	register int oi;
	// register: 17
	// size: 0x50
...
// line start: 274
// line end:   425
void GetDamageAmt__FiPiT1_addr_80139D54(int i, int *mind, int *maxd) {
	// register: 4
	register int k;
	// register: 5
	register int sl;
...
// line start: 274
// line end:   425
void GetDamageAmt__FiPiT1_addr_80139E5C(int i, int *mind, int *maxd) {
	// register: 4
	register int k;
	// register: 5
	register int sl;
...
// line start: 274
// line end:   425
void GetDamageAmt__FiPiT1_addr_801356CC(int i, int *mind, int *maxd) {
	// register: 4
	register int k;
	// register: 5
	register int sl;
...
// line start: 5219
// line end:   5244
void MI_Apoca__Fi_addr_80147F80(int i) {
	// register: 18
	register int j;
	// register: 17
	register int k;
...
// line start: 4545
// line end:   4581
void MI_Chain__Fi_addr_80146850(int i) {
	// register: 20
	// size: 0x50
	register struct MissileStruct_dup_17 *miss;
	// register: 23
...
// line start: 4426
// line end:   4469
void MI_Firemove__Fi_addr_801461FC(int i) {
	// register: 18
	register int j;
	// address: 0xFFFFFFA8
	// size: 0x38
...
// line start: 4426
// line end:   4469
void MI_Firemove__Fi_addr_80146304(int i) {
	// register: 18
	register int j;
	// address: 0xFFFFFFA8
	// size: 0x38
...
// line start: 5163
// line end:   5199
void MI_FirewallC__Fi_addr_80147CA0(int i) {
	// register: 16
	// size: 0x50
	register struct MissileStruct_dup_17 *miss;
	// register: 18
...
// line start: 5163
// line end:   5199
void MI_FirewallC__Fi_addr_80147B98(int i) {
	// register: 16
	// size: 0x50
	register struct MissileStruct *miss;
	// register: 18
...
// line start: 5450
// line end:   5477
void MI_Flamec__Fi_addr_80148B30(int i) {
	// register: 18
	register int id;
}
...
// line start: 4257
// line end:   4282
void MI_Flash2__Fi_addr_80145E38(int i) {
	// register: 17
	// size: 0x50
	register struct MissileStruct_dup_17 *miss;
}
...
// line start: 4219
// line end:   4252
void MI_Flash__Fi_addr_80145ACC(int i) {
	// register: 17
	// size: 0x50
	register struct MissileStruct_dup_17 *miss;
}
...
// line start: 3591
// line end:   3622
void MI_Golem__Fi_addr_80142F94(int i) {
	// register: 30
	register int id;
	// register: 19
	register int j;
...
// line start: 4473
// line end:   4540
void MI_Guardian__Fi_addr_801465A0(int i) {
	// register: 18
	register int j;
	// register: 22
	register int k;
...
// line start: 4070
// line end:   4137
void MI_Lightctrl__Fi_addr_801452E8(int i) {
	// register: 19
	register int dam;
	// register: 3
	register int p;
...
// line start: 4070
// line end:   4137
void MI_Lightctrl__Fi_addr_801451E0(int i) {
	// register: 19
	register int dam;
	// register: 3
	register int p;
...
// line start: 4140
// line end:   4159
void MI_Lightning__Fi_addr_80145594(int i) {
	// register: 16
	// size: 0x50
	register struct MissileStruct *miss;
}
...
// line start: 4140
// line end:   4159
void MI_Lightning__Fi_addr_8014569C(int i) {
	// register: 16
	// size: 0x50
	register struct MissileStruct_dup_17 *miss;
}
...
// line start: 4288
// line end:   4379
void MI_Manashield__Fi_addr_80145F04(int i, int xoffset[8][3]) {
	// register: 3
	register int j;
	// register: 18
	register int id;
...
// line start: 4288
// line end:   4379
void MI_Manashield__Fi_addr_8014600C(int i, int xoffset[8][3]) {
	// register: 3
	register int j;
	// register: 18
	register int id;
...
// line start: 4288
// line end:   4379
void MI_Manashield__Fi_addr_8014187C(int i, int xoffset[8][3]) {
	// register: 3
	register int j;
	// register: 18
	register int id;
...
// line start: 5008
// line end:   5081
void MI_Rhino__Fi_addr_801478B0(int i) {
	// register: 16
	register int mix;
	// register: 17
	register int miy;
...
// line start: 4964
// line end:   4991
void MI_Stone__Fi_addr_801475F8(int i) {
	// register: 4
	register int m;
}
...
// line start: 4797
// line end:   4847
void MI_Teleport__Fi_addr_8014718C(int i) {
	// register: 18
	register int id;
	// register: 19
	// size: 0x108
...
// line start: 4797
// line end:   4847
void MI_Teleport__Fi_addr_80142B4C(int i) {
	// register: 18
	register int id;
	// register: 19
	// size: 0x108
...
// line start: 4797
// line end:   4847
void MI_Teleport__Fi_addr_80147294(int i) {
	// register: 18
	register int id;
	// register: 19
	// size: 0x108
...
// line start: 4797
// line end:   4847
void MI_Teleport__Fi_addr_80142B04(int i) {
	// register: 18
	register int id;
	// register: 19
	// size: 0x108
...
// line start: 4166
// line end:   4216
void MI_Town__Fi_addr_80140FFC(int i) {
	// register: 4
	register int p;
	// address: 0xFFFFFFA8
	// size: 0x44
...
// line start: 4166
// line end:   4216
void MI_Town__Fi_addr_8014578C(int i) {
	// register: 4
	register int p;
	// address: 0xFFFFFFA8
	// size: 0x44
...
// line start: 4166
// line end:   4216
void MI_Town__Fi_addr_80145684(int i) {
	// register: 4
	register int p;
	// address: 0xFFFFFFA8
	// size: 0x44
...
// line start: 5249
// line end:   5305
void MI_Wave__Fi_addr_801481F8(int i) {
	// address: 0xFFFFFF88
	auto int dira;
	// address: 0xFFFFFF90
	auto int dirb;
...
// line start: 906
// line end:   1023
unsigned char MonsterMHit__FiiiiiiUc_addr_8013B5DC(int pnum, int m, int mindam, int maxdam, int dist, int t, int shift) {
	// register: 21
	register int hit;
	// register: 16
	register int hper;
...
// line start: 1030
// line end:   1155
unsigned char PlayerMHit__FiiiiiiUcUc_addr_8013BDA4(int pnum, int m, int dist, int mind, int maxd, int mtype, int shift, int earflag) {
	// address: 0xFFFFFFD0
	auto int hit;
	// register: 17
	register int hper;
...
// line start: 5764
// line end:   5828
void ProcessMissiles__Fv_addr_8014A064() {
	// register: 17
	register short i;
	// register: 3
	register short j;
...
// line start: 5764
// line end:   5828
void ProcessMissiles__Fv_addr_8014A16C() {
	// register: 17
	register short i;
	// register: 3
	register short j;
...
// line start: 656
// line end:   705
void PutMissile__Fi_addr_8013AD8C(int i) {
	// register: 8
	register int mx;
	// register: 9
	register int my;
