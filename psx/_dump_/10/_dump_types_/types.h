...
enum _136fake {
	MQ_BUTCHER_DUPLICATE_0  = 1,
	MQ_GARBUD_DUPLICATE_0   = 2,
	MQ_ZHAR_DUPLICATE_0     = 4,
	MQ_LTBANNER_DUPLICATE_0 = 8,
	MQ_VEIL_DUPLICATE_0     = 16,
	MQ_WARLORD_DUPLICATE_0  = 32,
	MQ_SKELKING_DUPLICATE_0 = 64,
	MQ_DIABLO_DUPLICATE_0   = 128,
	MQ_BETRAYER_DUPLICATE_0 = 256,
	MQ_SCHAMB_DUPLICATE_0   = 512,
	MQ_ANVIL_DUPLICATE_0    = 1024,
	MQ_PWATER_DUPLICATE_0   = 2048,
};
...
struct PlayerStruct {
	...
	// offset: 019B (17 bytes)
	unsigned char _pSLvlVisited[17];
	// offset: 01AC
	int _pGFXLoad;
	// offset: 01B0
	unsigned char peq;
	...
	// offset: 01D4
	int _pBFrames;
	// offset: 01D8 (1036 bytes)
	struct ItemStruct InvBody[7];
	// offset: 05E4 (5920 bytes)
	struct ItemStruct InvList[40];
	// offset: 1D04
	int _pNumInv;
	// offset: 1D08 (40 bytes)
	char InvGrid[40];
	// offset: 1D30 (1184 bytes)
	struct ItemStruct SpdList[8];
	// offset: 21D0 (148 bytes)
...
struct Spell_Target {
	...
	// offset: 0017
	unsigned char splpos;
	// offset: 0018
	unsigned char maxrad;
};

// size: 0x90
struct GamePad {
	// offset: 0000 (8912 bytes)
	...
	// offset: 0010
	void (*pad_up_action)();
	// offset: 0014 (108 bytes)
	struct CPad *Pad;
	// offset: 0018
	int combo_key;
	// offset: 001C
	unsigned char await_combo;
	// offset: 0020 (56 bytes)
	void (*button_down[14])();
	// offset: 0058 (56 bytes)
...
// size: 0x18C
struct t10Collection2Z8PalEntryi16 {
	// offset: 0000
	int ObjsUsed;
	// offset: 0004 (384 bytes)
	struct PalEntry Objects[16];
	// offset: 0184 (24 bytes)
...
struct PalCollection {
	// offset: 0000 (396 bytes)
	struct t10Collection2Z8PalEntryi16 t10Collection2Z8PalEntryi16;
};
...
struct DecEnv {
	...
	short imageId;
	// offset: 003C (8 bytes)
	unsigned long *vlcBuffer[2];
	// offset: 0044 (8 bytes)
	unsigned long *imageBuffer[2];
	// offset: 004C (40 bytes)
...
struct _fontspecs {
	// offset: 0000
	unsigned char bCharWidth;
	// offset: 0001
	unsigned char bCharHeight;
	// offset: 0002 (256 bytes)
	unsigned char bCharWidths[256];
};

// size: 0x508
struct _artfont {
	// offset: 0000 (258 bytes)
	struct _fontspecs tFontSpecs;
	// offset: 0104 (1024 bytes)
	void *pCharData[256];
	// offset: 0504
...
typedef struct t10Collection2Z8PalEntryi16 t10Collection2Z8PalEntryi16;
...
typedef struct _fontspecs _fontspecs;

typedef struct _fontspecs TFONTSPECS;

typedef struct _fontspecs *TPFONTSPECS;

typedef struct _artfont _artfont;

typedef struct _artfont TARTFONT;
