...
struct CBlocks {
	...
	// offset: 0068
	int MonstTexId;
	// offset: 006C (104 bytes)
	struct TextDat *MonstTexDat;
	// offset: 0070 (16 bytes)
	struct MonstList *MonsterList;
	// offset: 0074
	int ObjTexId;
	// offset: 0078 (104 bytes)
	struct TextDat *ObjTexDat;
	// offset: 007C
	int ItemTexId;
	// offset: 0080 (104 bytes)
	struct TextDat *ItemTexDat;
	// offset: 0084
	int BgTexId;
	// offset: 0088 (104 bytes)
...
struct MisFileData {
	...
	// offset: 0003 (16 bytes)
	unsigned char mAnimDelay[16];
	// offset: 0013 (16 bytes)
